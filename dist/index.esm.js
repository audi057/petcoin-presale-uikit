...
var HelpLink = styled(Link)(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
...
var BuyBusdButtonStyled = styled(Button)(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  padding: 15px;\n  height: 30px;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: #e59447;\n  border: 1px solid #fff;\n  margin-right: 10px;\n  vertical-align: sub;\n\n  &.polygon {\n    &:hover:not(:disabled):not(.button--disabled):not(:active) {\n      background-color: #a175ea !important;\n    }\n  }\n\n  .text {\n    display: none;\n  }\n\n  @media(min-width:600px) {\n    padding: 15px 20px;\n\n    svg {\n      padding-right: 10px;\n    }\n\n    .text {\n      display: block;\n    }\n\n  }\n"], ["\n  padding: 15px;\n  height: 30px;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: #e59447;\n  border: 1px solid #fff;\n  margin-right: 10px;\n  vertical-align: sub;\n\n  &.polygon {\n    &:hover:not(:disabled):not(.button--disabled):not(:active) {\n      background-color: #a175ea !important;\n    }\n  }\n\n  .text {\n    display: none;\n  }\n\n  @media(min-width:600px) {\n    padding: 15px 20px;\n\n    svg {\n      padding-right: 10px;\n    }\n\n    .text {\n      display: block;\n    }\n\n  }\n"])));
var BuyBusdButton = function (_a) {
    return (React.createElement("a", { href: "https://buy.moonpay.com/?currencyCode=busd_bsc", target: "_blank" },
        React.createElement(BuyBusdButtonStyled, { className: 'buy-btn' },
                React.createElement(React.Fragment, null,
                    React.createElement("svg", { height: "20px", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 2500.01 2500", fill: "#ffffff" },
                        React.createElement("g", { id: "Layer_2" },
                            React.createElement("g", { id: "Layer_1-2" },
                                React.createElement("path", { className: "cls-1", d: "M764.48,1050.52,1250,565l485.75,485.73,282.5-282.5L1250,0,482,768l282.49,282.5M0,1250,282.51,967.45,565,1249.94,282.49,1532.45Zm764.48,199.51L1250,1935l485.74-485.72,282.65,282.35-.14.15L1250,2500,482,1732l-.4-.4,282.91-282.12M1935,1250.12l282.51-282.51L2500,1250.1,2217.5,1532.61Z" }),
                                React.createElement("path", { className: "cls-1", d: "M1536.52,1249.85h.12L1250,963.19,1038.13,1175h0l-24.34,24.35-50.2,50.21-.4.39.4.41L1250,1536.81l286.66-286.66.14-.16-.26-.14" })))),
                    React.createElement("span", { className: "text" }, "Buy BUSD")))));
};
var templateObject_1$G;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#00205b", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
